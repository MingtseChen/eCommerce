            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{route('product.update',['id' => $data->id])}}"
                            ...
                            <div class="form-group{{ $errors->has('release_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="release_date" type="text" class="form-control" name="release_date"
                                           value="{{$data->release_date}}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('auther') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="auther" type="text" class="form-control" name="auther"
                            ...
                            <div class="form-group{{ $errors->has('retailer') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="retailer" type="text" class="form-control" name="retailer"
                                           value="{{$data->retailer}}" required
                                           autofocus>
                            ...
                            <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="desc" class="form-control" name="desc" autofocus
                                              style="height: 200px">{{$data->desc}}</textarea>
                                    @if ($errors->has('desc'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('ISBN') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="ISBN" type="text" class="form-control" name="ISBN"
                                           value="{{$data->ISBN}}" required autofocus>
